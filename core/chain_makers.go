...
func (b *BlockGen) OffsetTime(seconds int64) {
	...
	b.header.Difficulty = b.engine.CalcDifficulty(b.chainReader, b.header.Time.Uint64(), b.header.Coinbase, b.parent.Header())
}
...
func makeHeader(chain consensus.ChainReader, parent *types.Block, state *state.StateDB, engine consensus.Engine) *types.Header {
	...
	return &types.Header{
		...
		Difficulty: engine.CalcDifficulty(chain, time.Uint64(), parent.Coinbase(), &types.Header{
